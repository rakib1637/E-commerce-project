...
<div class="container">
  ...
  <div class="row">
    ...
    <div id="content" class="col-sm-9">
      <h2 class="category-title">All Porduct in {{$category->name}}</h2>
      <div class="row category-banner">
         <div class="col-sm-12 category-image"><img src="{{asset('Forntend/image/banners/category-banner.jpg')}}" alt="Desktops" title="Desktops" class="img-thumbnail" />
         </div>
      ...
      <div class="grid-list-wrapper">
        ...
        @else
        <div class="alert alert-warning"> SORRY!! No product found in this category</div>
        @endif
