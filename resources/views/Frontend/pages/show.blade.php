               ...
               <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                  ...
                  <div class="carousel-inner" role="listbox">
                    ...
                    <div class="item {{$i==1? 'active':''}}">
                      <img src="{{asset('Forntend/image/'. $image->image)}}" alt="{{$product->title}}">
                    </div>
                    @php $i++ @endphp
                    @endforeach
                  </div>
        ...
        <div class="col-sm-6">
          ...
          <ul class="list-unstyled product_info">
            ...
            <li>
              ...
              {{$product->quantaty < 1 ? 'This Product out of stock' : $product->quantaty . 'psc in stock'}}
