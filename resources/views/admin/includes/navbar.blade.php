      ...
      <li class="nav-item">
        ...
        <div id="Category" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{route('createcategory')}}">Add new Category</a>
            <a class="collapse-item" href="{{route('managecategory')}}">Manage All Category</a>
          </div>
        </div>
      </li>
        <!-- Nav Item - Products Menu Menu -->
      <li class="nav-item">
