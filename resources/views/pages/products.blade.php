  ...
  <div class="row">
    ...
    <div id="content" class="col-sm-9">
      ...
      <div class="row category-banner">
         <div class="col-sm-12 category-image"><img src="Forntend/image/banners/category-banner.jpg" alt="Desktops" title="Desktops" class="img-thumbnail" />
         </div>
          ...
          <div class="product-thumb">
            ...
            <div class="caption product-detail">
              <h4 class="product-name"> 
                <!--Product Title -->
                <a href="product.html" title="lorem ippsum dolor dummy">{{$product->title}}</a> </h4>
                <!--Prodcut Description-->
